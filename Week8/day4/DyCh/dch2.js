...
function getCarHonda(carInventory) {
    const firstHonda = carInventory.find((inventory) => inventory.car_make === 'Honda'); 
    const sent =  `This is a ${firstHonda.car_make} ${firstHonda.car_model} from ${firstHonda.car_year}`;
    console.log(sent)
} 
...
function sortCarInventoryByYear(carInventory) {
    const result = carInventory.sort((a,b) => a.car_year < b.car_year ? -1 : 1);
    console.log(result)
}
